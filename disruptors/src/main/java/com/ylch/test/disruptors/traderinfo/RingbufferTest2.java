...
public class RingbufferTest2 {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
      ...
      /*  BatchEventProcessor<TraderInfo> transProcessor = new BatchEventProcessor<TraderInfo>(
                ringBuffer, sequenceBarrier, new traderInfoHander());
*/
      ...
      /*  ringBuffer.addGatingSequences(transProcessor.getSequence());*/
       ...
       /* executors.submit(transProcessor);*/
        ...
        WorkHandler<TraderInfo> workHandlers=new TraderInfoHandler();
        WorkerPool<TraderInfo> workerPool=new WorkerPool<TraderInfo>(ringBuffer, sequenceBarrier, new IgnoreExceptionHandler(), workHandlers);
